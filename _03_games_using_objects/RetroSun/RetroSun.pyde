...
def setup():
    global bg_color, sun_colors, sun_radius, y, h, w, x
    """
    ...
    * See 1st image
    ...
    fill(sun_colors[0])
    ellipse(400,400,sun_radius,sun_radius)
    noStroke()
    ...
    * top to bottom
    ...
    x = 400 - sun_radius
    w = 2 * sun_radius
    yincrement = (sun_radius+(sun_radius/4)) / 5

    # Call updatePixels() to apply th0e changes made to the pixels list
    global rectangles
